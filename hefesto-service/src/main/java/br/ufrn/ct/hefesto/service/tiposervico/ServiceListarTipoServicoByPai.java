...
@Service("ListarTipoServicoByPai")
public class ServiceListarTipoServicoByPai implements IServiceConsultar<TipoServicoModel, ListarTipoServicoByPai>{
	...
	@Transactional
	public List<TipoServicoModel> consultar(ListarTipoServicoByPai request) throws NegocioException {
		...
		for (TipoServico tipoServico : this.tipoServicoDao.findFilhosByPai(request.getIdTipoServicoPai(), pessoaLogada.getUnidadeLocalizacao().getId())) {
	...
	public void validar(ListarTipoServicoByPai arg0) throws NegocioException {
